        ...
        <div className="about-me-container">
            <div className="profile">
                ...
                <div className="profile-info">
                    ...
                    <p className="additional-about">I have done tons of software development projects over the years.
                    I also worked as Full Stack Development Intern at Value Wealth Creators
                    I have a youtube channel where I try to 
                    solve frontend challenges like.</p>

                    <p className="additional-about">I spend most of my time learning new technologies and frameworks. I like to do competitive programming and solve algorithm-related problems on
                    Codechef. When I am not coding, I like to design UI/UX on Figma.  </p>

                    <p className="additional-about">In my free-time I listen to music. I am a huge supporter of Manchester United FC and Mumbai Indians.
